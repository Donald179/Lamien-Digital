...
if (empty($telephone)) {
    ...
    $errors[] = 'Numéro de téléphone invalide. Format attendu: +226 XX XX XX XX';
}
...
try {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Erreur de connexion à la base de données. Vérifiez que XAMPP est lancé et que la base techburk_db existe.'
    ]);
}
